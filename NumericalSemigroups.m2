newPackage(
        ...
        Version => "0.1",
        Date => "July 29, 2017",
        Authors => {{Name => "Ilir Dema",
                     Email => "ilir.dema@mail.utoronto.ca",
                     HomePage => "http://teach.cs.toronto.edu/~dema"}},
        Headline => "NUmerical Semigroups Computations",
        DebuggingMode => false
        )

export{"numericalSemigroup","frobeniusNumber"}
...
--frobeniusNumber n1
numericalSemigroup L
n1 = numericalSemigroup L
nn = new NumericalSemigroup from n1
